L.Control.ZoomBar=L.Control.extend(
    ...
    onAdd:function(b){
        ...
        this._zoomStartButton=this._createButton("","Zoom to Start Position","leaflet-control-zoom-to-start",a,this._zoomStart,this);
    ...
    _zoomStart:function(a){this._map.setView(this._zoomStartLatLng,this._zoomStartZoom)},
    _zoomIn:function(a){this._map.zoomIn(a.shiftKey?3:1)},
    _zoomOut:function(a){this._map.zoomOut(a.shiftKey?3:1)},
    _zoomToArea:function(a){L.DomUtil.addClass(this._map._container,"crosshair-cursor-enabled");
